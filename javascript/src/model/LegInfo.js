(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './CallerInfo', './LegInfoExtensionInfo', './RecordingInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CallerInfo'), require('./LegInfoExtensionInfo'), require('./RecordingInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.RingCentralApi) {
      root.RingCentralApi = {};
    }
    root.RingCentralApi.LegInfo = factory(root.RingCentralApi.ApiClient, root.RingCentralApi.CallerInfo, root.RingCentralApi.LegInfoExtensionInfo, root.RingCentralApi.RecordingInfo);
  }
}(this, function(ApiClient, CallerInfo, LegInfoExtensionInfo, RecordingInfo) {
  'use strict';

  /**
   * The LegInfo model module.
   * @module model/LegInfo
   * @version v1.0
   */

  /**
   * Constructs a new <code>LegInfo</code>.
   * @alias module:model/LegInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>LegInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LegInfo} obj Optional instance to populate.
   * @return {module:model/LegInfo} The populated <code>LegInfo</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('extension')) {
        obj['extension'] = LegInfoExtensionInfo.constructFromObject(data['extension']);
      }
      if (data.hasOwnProperty('legType')) {
        obj['legType'] = ApiClient.convertToType(data['legType'], 'String');
      }
   ...
   * @member {module:model/LegInfo.ActionEnum} action
   */
  exports.prototype['action'] = undefined;

  /**
   * Call direction
   * @member {module:model/LegInfo.DirectionEnum} direction
   */
  ...
  /**
   * @member {module:model/LegInfoExtensionInfo} extension
   */
  exports.prototype['extension'] = undefined;

  /**
   * Leg type
   * @member {String} legType
   */
  exports.prototype['legType'] = undefined;
  ...
  /**
   * Call type
   * @member {module:model/LegInfo.TypeEnum} type
   */
  exports.prototype['type'] = undefined;

  /**
   * Status description of the call operation
   * @member {module:model/LegInfo.ResultEnum} result
   */
  ...
  /**
   * Call transport
   * @member {module:model/LegInfo.TransportEnum} transport
   */
