(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './CallerInfo', './LegInfo', './RecordingInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CallerInfo'), require('./LegInfo'), require('./RecordingInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.RingCentralApi) {
      root.RingCentralApi = {};
    }
    root.RingCentralApi.CallLogRecord = factory(root.RingCentralApi.ApiClient, root.RingCentralApi.CallerInfo, root.RingCentralApi.LegInfo, root.RingCentralApi.RecordingInfo);
  }
}(this, function(ApiClient, CallerInfo, LegInfo, RecordingInfo) {
  'use strict';

  /**
   * The CallLogRecord model module.
   * @module model/CallLogRecord
   * @version v1.0
   */

  /**
   * Constructs a new <code>CallLogRecord</code>.
   * @alias module:model/CallLogRecord
   * @class
   */
  ...
  /**
   * Constructs a <code>CallLogRecord</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CallLogRecord} obj Optional instance to populate.
   * @return {module:model/CallLogRecord} The populated <code>CallLogRecord</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('legs')) {
        obj['legs'] = ApiClient.convertToType(data['legs'], [LegInfo]);
      }
    }
    return obj;
  }
  ...
  /**
   * Call type
   * @member {module:model/CallLogRecord.TypeEnum} type
   */
  exports.prototype['type'] = undefined;

  /**
   * Call direction
   * @member {module:model/CallLogRecord.DirectionEnum} direction
   */
  exports.prototype['direction'] = undefined;

  /**
   * Action description of the call operation
   * @member {module:model/CallLogRecord.ActionEnum} action
   */
  exports.prototype['action'] = undefined;

  /**
   * Status description of the call operation
   * @member {module:model/CallLogRecord.ResultEnum} result
   */
   ...
   * @member {module:model/CallLogRecord.TransportEnum} transport
   */
  exports.prototype['transport'] = undefined;

  /**
   * For 'Detailed' view only. Leg description
   * @member {Array.<module:model/LegInfo>} legs
   */
