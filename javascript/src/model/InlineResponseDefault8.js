(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RingCentralApi.InlineResponseDefault8 = factory(root.RingCentralApi.ApiClient, root.RingCentralApi.NavigationInfo, root.RingCentralApi.PagingInfo, root.RingCentralApi.PhoneNumberInfo);
  }
}(this, function(ApiClient, NavigationInfo, PagingInfo, PhoneNumberInfo) {
  'use strict';

  /**
   * The InlineResponseDefault8 model module.
   * @module model/InlineResponseDefault8
   * @version v1.0
   */

  /**
   * Constructs a new <code>InlineResponseDefault8</code>.
   * @alias module:model/InlineResponseDefault8
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponseDefault8</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponseDefault8} obj Optional instance to populate.
   * @return {module:model/InlineResponseDefault8} The populated <code>InlineResponseDefault8</code> instance.
   */
