...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponseDefault13 :  IEquatable<InlineResponseDefault13>
    { 
        ...
        public List<StateInfo> Records { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponseDefault13);
        }

        /// <summary>
        /// Returns true if InlineResponseDefault13 instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponseDefault13 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponseDefault13 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
