...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceInfoExtensionInfo :  IEquatable<DeviceInfoExtensionInfo>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceInfoExtensionInfo" /> class.
        /// Initializes a new instance of the <see cref="DeviceInfoExtensionInfo" />class.
        /// </summary>
        ...
        public DeviceInfoExtensionInfo(string Id = null, string Uri = null, string ExtensionNumber = null, string PartnerId = null)
        {
            this.Id = Id;
            this.Uri = Uri;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DeviceInfoExtensionInfo);
        }

        /// <summary>
        /// Returns true if DeviceInfoExtensionInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of DeviceInfoExtensionInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceInfoExtensionInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
