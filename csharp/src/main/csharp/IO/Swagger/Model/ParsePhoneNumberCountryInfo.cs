...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ParsePhoneNumberCountryInfo :  IEquatable<ParsePhoneNumberCountryInfo>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsePhoneNumberCountryInfo" /> class.
        /// Initializes a new instance of the <see cref="ParsePhoneNumberCountryInfo" />class.
        /// </summary>
        ...
        public ParsePhoneNumberCountryInfo(string Id = null, string Uri = null, string CallingCode = null, bool? EmergencyCalling = null, string IsoCode = null, string Name = null)
        {
            this.Id = Id;
            this.Uri = Uri;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ParsePhoneNumberCountryInfo);
        }

        /// <summary>
        /// Returns true if ParsePhoneNumberCountryInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of ParsePhoneNumberCountryInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParsePhoneNumberCountryInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
