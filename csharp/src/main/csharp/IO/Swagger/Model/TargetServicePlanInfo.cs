...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TargetServicePlanInfo :  IEquatable<TargetServicePlanInfo>
    { 
        ...
        public TargetServicePlanInfo(string Id = null, string Name = null)
        {
            this.Id = Id;
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TargetServicePlanInfo);
        }

        /// <summary>
        /// Returns true if TargetServicePlanInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of TargetServicePlanInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetServicePlanInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
