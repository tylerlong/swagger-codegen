...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServerInfo :  IEquatable<ServerInfo>
    { 
        ...
        public ServerInfo(string Uri = null, List<VersionInfo> ApiVersions = null, string ServerVersion = null, string ServerRevision = null)
        {
            this.Uri = Uri;
