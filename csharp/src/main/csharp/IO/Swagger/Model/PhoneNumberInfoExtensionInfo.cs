...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PhoneNumberInfoExtensionInfo :  IEquatable<PhoneNumberInfoExtensionInfo>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneNumberInfoExtensionInfo" /> class.
        /// Initializes a new instance of the <see cref="PhoneNumberInfoExtensionInfo" />class.
        /// </summary>
        ...
        public PhoneNumberInfoExtensionInfo(string Id = null, string Uri = null, string ExtensionNumber = null, string PartnerId = null)
        {
            this.Id = Id;
            this.Uri = Uri;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PhoneNumberInfoExtensionInfo);
        }

        /// <summary>
        /// Returns true if PhoneNumberInfoExtensionInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of PhoneNumberInfoExtensionInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhoneNumberInfoExtensionInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
