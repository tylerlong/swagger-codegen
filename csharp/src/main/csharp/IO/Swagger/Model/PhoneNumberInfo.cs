...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PhoneNumberInfo :  IEquatable<PhoneNumberInfo>
    { 
        ...
        public PhoneNumberInfoExtensionInfo Extension { get; set; }
        ...
        /// </summary>
        /// <value>Indicates if this phone number is enabled to appear as CallerId and/or to send outbound SMS from it. Returned only for the request of Extension phone number list</value>
        ...
        /// </summary>
        /// <param name="other">Instance of PhoneNumberInfo to be compared</param>
        /// <returns>Boolean</returns>
