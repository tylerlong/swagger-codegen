...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmergencyAddressInfo :  IEquatable<EmergencyAddressInfo>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="EmergencyAddressInfo" /> class.
        /// Initializes a new instance of the <see cref="EmergencyAddressInfo" />class.
        /// </summary>
        ...
        public EmergencyAddressInfo(string CustomerName = null, string Street = null, string Street2 = null, string City = null, string State = null, string Zip = null, string Country = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EmergencyAddressInfo);
        }

        /// <summary>
        /// Returns true if EmergencyAddressInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of EmergencyAddressInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmergencyAddressInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
